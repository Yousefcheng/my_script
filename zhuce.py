...
# me填写你小程序的openid ，invitePin填你的pin值
...
salt = "cXRofWK6"
invitePin = "jd_4d6f1c7a79773"  # 我的pin
me = "oKvo342MPZX9ZvwYlfGNhFN_kR7g"  # 小程序openid
group_size = 50 #并发数
...
async def task(ck, promotionId):
    ...
    while True:
        ...
        if result['code']==-100 or '未登录' in str(result):
            return
        if result["code"] == 0 and success == 8:
